...
* **[BinBench: a benchmark for x64 portable operating system interface binary function representations](https://peerj.com/articles/cs-1286/)** – *PeerJ Computer Science* (2023). Developed a framework for evaluating Machine Learning model generality across assembly-level analysis tasks.
